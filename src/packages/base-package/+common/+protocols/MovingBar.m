classdef MovingBar < common.protocols.CommonStageProtocol
    properties
    ...
    methods
        ...
        function prepareDefaultFigures(obj)
            prepareDefaultFigures@common.protocols.CommonStageProtocol(obj);

            % Add the direction figure
            if ~obj.isMeaRig && ~strcmp(obj.onlineAnalysis, 'none')
                if length(unique(obj.orientations)) > 1
                    obj.showFigure('common.figures.DirectionFigure', ...
                        obj.rig.getDevice(obj.amp),'recordingType',obj.onlineAnalysis,...
                        'preTime', obj.preTime, 'stimTime', obj.stimTime, ...
                        'orientations', unique(obj.orientations));
                else
                    obj.showFigure('common.figures.ContrastResponseFigure', ...
                        obj.rig.getDevice(obj.amp),'recordingType',obj.onlineAnalysis,...
                        'preTime',obj.preTime,...
